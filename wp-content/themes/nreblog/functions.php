...
function nreblog_scripts() {
	...
	wp_enqueue_script( 'main-js', get_theme_file_uri( '/assets/app.js' ), array( 'jquery' ), '1.2.2', true );
	wp_enqueue_style( 'main-css', get_theme_file_uri( '/assets/app.css' ), '', '1.2.2', 'all' );
